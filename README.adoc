...
https://github.com/kieranpotts/resume/releases/latest[image:https://img.shields.io/github/v/release/kieranpotts/resume?style=flat-square&label=latest&labelColor=%23333333&color=%232266EE[GitHub release]]
...
The compilation scripts run in a Docker container, so you do not need to install any LaTeX packages on your host system. The Docker image is based on my own https://hub.docker.com/r/kieranpotts/latex[Docker image], which is in turn inspired by Benedikt Lang's https://github.com/blang/latex-docker/[blang/latex] images.
