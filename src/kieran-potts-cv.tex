...
\begin{document}
  ...
  \begin{minipage}{\textwidth}
    ...
    \resumeListStart
      ...
      \resumeItem{Architected for scalability from the start with denormalisation and read-write segregation}
  ...
  \begin{minipage}{\textwidth}
    ...
    \resumeListStart
      ...
      \resumeItem{Optimised slow-running SQL queries through indexing, denormalisation, and simplified joins}
