...
\begin{document}
  ...
  \begin{center}
    {\scshape{Solution Architecture}} · {\scshape{Computer Programming}} · {\scshape{Technical Writing}}
  \end{center}

  \smallskip

  \begin{center}
    \small{20\raisebox{+0.25ex}{\tiny +} years experience making web-based enterprise application software. Full-stack, product-oriented approach:\\
    collaborating directly with users, and working across the whole development lifecycle, to deliver high value software.}
  \end{center}
