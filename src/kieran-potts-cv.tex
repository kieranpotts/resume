...
\begin{document}
  ...
  %%  for big data processing and analytics, owned and maintained by LexisNexis.
    ...
    \resumeListStart
      ...
      \resumeItem{Built out new HTTP API services, programmed in PHP on Laravel with role-based access controls}
      \resumeItem{Integrated third-party data sources such as the National Fraud Initiative}
      \resumeItem{Integrated with the IDverse remote identity verification service}
      ...
      \resumeItem{Maintained high code coverage through a combination of unit and integration tests}
