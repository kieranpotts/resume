...
\begin{document}
  ...
  \begin{minipage}{\textwidth}
    ...
    \resumeListStart
      ...
      \resumeItem{Maintained a \skill{Vue}-based UI component library, documented using Storybook}
  ...
  \begin{minipage}{\textwidth}
    ...
    \resumeListStart
      ...
      \resumeItem{Contributed to a library of custom UI components built with \skill{Vue}}
  ...
  \begin{minipage}{\textwidth}
    ...
    \resumeListStart
      ...
      \resumeItem{Built a \skill{single-page web application} using \skill{React} and an \skill{HTTP API} service}
