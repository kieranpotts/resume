...
\begin{document}
  ...
  \begin{center}
    {\scshape{Web Application Development}} · {\scshape{Cloud Software Architecture}} · {\scshape{Technical Writing}}
  \end{center}
  ...
  \begin{minipage}{\textwidth}
    ...
    \resumeListStart
      ...
      \resumeItem{Designed a GraphQL API gateway service and established client-server contracts}
  ...
  \begin{minipage}{\textwidth}
    ...
    \resumeListStart
      ...
      \resumeItem{Built a single-page web application using React and an HTTP API service}
  ...
  \begin{minipage}{\textwidth}
    ...
    \resumeListStart
      ...
      \resumeItem{Led the development of a replacement React web UI and supervised iOS and Android client development}
