...
\begin{document}
  ...
  \begin{center}
    {\scshape{Software Architecture}} · {\scshape{Computer Programming}} · {\scshape{Technical Writing}}
  \end{center}

  \smallskip

  \begin{center}
    \small{Contract software developer with 20\raisebox{+0.25ex}{\tiny +} years experience designing, building,\\
